    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/YuraEtalking/foodgram" className={styles.textLink}>YuraEtalking</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/YuraEtalking" className={styles.textLink}>Юрий Рыжков</a>
            </p>
          </div>
        </aside>
      </div>
